...
that golden.BaseTest functions as intended.
"""
...
class GoldenBaseTest(golden.BaseTest):
  ...
  def _uniform_random_ops(self, test=False, wrong_name=False, wrong_shape=False,
    ...
    self._manage_ops(name=name, g=g, ops_to_eval=[input_tensor], test=test,
  ...
  def _dense_ops(self, test=False):
    ...
    self._manage_ops(name=name, g=g, ops_to_eval=[layer], test=test,
